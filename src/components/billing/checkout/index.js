...
const Checkout = ({ cartProducts, token }) => {
  ...
  const handleSubmit=(e)=>{
    ...
    //  console.log(billingUser,billingUserAddressLine1,billingUserAddressLine2,billingUserCity,billingUserEmail,billingUserPhone,billingUserState,billingUserZipCode)
            ...
            <div className="mb-4">
              ...
              <div className="row">
                ...
                <div className="col-md-6 form-group">
                  ...
                  />
                        {error.phone && <h5 style={{ color: 'red' }}>{error.phone}</h5>}
                ...
                <div className="col-md-6 form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setBillingUserAddressLine1(e.target.value)}
                    required
                  />
                </div>
                <div className="col-md-6 form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setBillingUserAddressLine2(e.target.value)}
                    required
                  />
                </div>
              ...
              {cartProducts.map((product,index) => {
                {
                  total =
                    total +
                    product.quantity * product.service.price.$numberDecimal;
                }
                return (
                    <div className="card-body">
                  <div className="row d-flex justify-content-between">
